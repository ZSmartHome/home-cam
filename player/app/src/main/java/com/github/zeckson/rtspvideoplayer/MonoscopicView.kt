...
/** Inflates a standard GLSurfaceView.  */
     ...
     * [com.google.vr.sdk.widgets.common.TouchTracker.FlingGestureListener] can be used with
     ...
     */
    internal class TouchTracker(private val renderer: Renderer) : View.OnTouchListener {
        ...
        override fun onTouch(v: View, event: MotionEvent): Boolean {
            when (event.action) {
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    val cr = Math.cos(r.toDouble()).toFloat()
                    val sr = Math.sin(r.toDouble()).toFloat()
                    ...
                    accumulatedTouchOffsetDegrees.y = Math.max(
                        -MAX_PITCH_DEGREES,
     ...
     */
    internal class Renderer(private val uiView: VideoUiView?, private val mediaLoader: MediaLoader) :
        GLSurfaceView.Renderer {
        private val scene = SceneRenderer.createFor2D()
        ...
        private var touchPitch: Float = 0.toFloat()
        private var deviceRoll: Float = 0.toFloat()
        ...
        override fun onSurfaceChanged(gl: GL10, width: Int, height: Int) {
            ...
            Matrix.perspectiveM(
                projectionMatrix, 0, FIELD_OF_VIEW_DEGREES.toFloat(), width.toFloat() / height, Z_NEAR, Z_FAR
            )
        }
        ...
        private fun updatePitchMatrix() {
            ...
            Matrix.setRotateM(
                touchPitchMatrix, 0,
                -touchPitch, Math.cos(deviceRoll.toDouble()).toFloat(), Math.sin(deviceRoll.toDouble()).toFloat(), 0f
            )
        }
        ...
        companion object {
            ...
            private val FIELD_OF_VIEW_DEGREES = 90
