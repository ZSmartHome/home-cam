...
import com.github.zeckson.rtspvideoplayer.renderer.CanvasQuad
...
/** Creates this View using standard XML inflation.  */
    ...
    override fun onInterceptTouchEvent(event: MotionEvent): Boolean {
        ...
        return if (event.source != InputDevice.SOURCE_GAMEPAD) {
    ...
    public override fun onFinishInflate() {
        ...
        val playPauseToggle = findViewById(R.id.play_pause_toggle) as ImageButton
        ...
        statusText = findViewById(R.id.status_text) as TextView
    }

    /** Sets the OnClickListener used to switch Activities.  */
    @MainThread
    fun setVrIconClickListener(listener: View.OnClickListener) {
        val vrIcon = findViewById(R.id.enter_exit_vr) as ImageButton
    ...
    public override fun dispatchDraw(androidUiCanvas: Canvas) {
        ...
        // Handle VR rendering.
        val glCanvas = canvasQuad!!.lockCanvas()
        if (glCanvas == null) {
    ...
    private inner class UiUpdater : SurfaceTexture.OnFrameAvailableListener {
        ...
        private val uiThreadUpdater = Runnable {
            ...
            if (videoDurationMs == 0) {
                videoDurationMs = mediaPlayer!!.duration
    ...
    companion object {
         ...
         */
        @MainThread
        fun createForOpenGl(context: Context, parent: ViewGroup, quad: CanvasQuad): VideoUiView {
            ...
            val theme = ContextThemeWrapper(context, R.style.VrTheme)

            val view = View.inflate(theme, R.layout.video_ui, null) as VideoUiView
            view.canvasQuad = quad
            view.layoutParams = CanvasQuad.layoutParams
            view.visibility = View.VISIBLE
            parent.addView(view, 0)

            (view.findViewById(R.id.enter_exit_vr) as View).contentDescription =
